...
> **Post-merge status (2026-07-31):** Integrated into `develop` via PR, verified locally
> (typecheck 8/8, IPC contract OK, cargo check clean, cargo test 27/27, clippy clean,
> next build compiles). The two "Repo hygiene" notes below are now stale: the `c5cd8ef`
> marketplace commit was already cherry-picked to `develop` as `9870b86`, and the GitHub
