...
_Rationale:_ Tauri allows us to use Rust for high-performance indexing, file-system operations, and security, while maintaining the industry-leading DX of the React ecosystem for the UI.
...
_For structured, relational project data._
...
_For semantic search and project intelligence._
...
_Blueprint Implementation Architecture — Finalized for Construction._
